...
const PRODUCTS = [
  {
    ...
    description: "Bíblia com comentários, mapas e referências cruzadas.",
    price: "R$ 89,90",
    link: "#",
  },
  {
    name: "Livro: Fundamentos da Fé",
    description: "Um guia essencial para novos convertidos e estudiosos.",
    price: "R$ 39,90",
    link: "#",
  },
  {
    name: "Devocional Diário",
    description: "365 reflexões para alimentar sua vida espiritual.",
    price: "R$ 49,90",
    link: "#",
  },
  {
    name: "Curso de Teologia Online",
    description: "Aprenda teologia no seu ritmo com professores qualificados.",
    price: "R$ 197,00",
    link: "#",
  },
  {
    name: "Caderno de Estudos Bíblicos",
    ...
    <div className="mx-auto max-w-6xl px-6 py-20">
      <section className="mb-16 text-center">
        ...
        <p className="mx-auto max-w-2xl text-muted-foreground leading-relaxed">
          Livros, cursos e materiais selecionados para aprofundar seu
          conhecimento bíblico e crescimento espiritual.
        </p>
      </section>
        ...
        {PRODUCTS.map((product) => (
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="rounded-full bg-accent px-4 py-1.5 text-xs font-semibold text-accent-foreground group-hover:opacity-90 transition-opacity">
                Ver detalhes
              </span>
            </div>
          </Link>
      ...
      <div className="rounded-3xl border border-accent/20 bg-accent/5 p-8 sm:p-12 text-center">
        <h2 className="mb-4 text-2xl font-bold font-serif text-foreground">
        ...
        <p className="mx-auto mb-8 max-w-xl text-sm leading-relaxed text-muted-foreground">
          ...
          por cada venda realizada através do seu link. Inscreva-se abaixo para
          ser notificado.
        </p>
        <button
          type="button"
          className="rounded-full bg-accent px-8 py-3 text-sm font-semibold text-accent-foreground hover:opacity-90 transition-opacity"
        >
          Quero ser afiliado
        </button>
      </div>
